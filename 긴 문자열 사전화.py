...
def MakeDict(sList) :    # 문자열 리스트 sList를 받아 Dictionary 를 구성하는 함수
    for n in sList :
...
"to solving a difficult data analysis problem to having fun to helping someone else solve a problem.",
"This book assumes that everyone needs to know how to program and that once you know how to program,",
...
"The hardware in our current-day computers is essentially built to continuously",
"ask us the question, \"What would you like me to do next?\”",

"Our computers are fast and have vast amounts of memory and could be very helpful to us",
"if we only knew the language to speak to explain to the computer what we would like it to do next.",
